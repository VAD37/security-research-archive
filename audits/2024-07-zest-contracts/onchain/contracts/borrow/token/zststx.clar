(use-trait ft .ft-mint-trait.ft-mint-trait) ;;transfer,withdraw,mint,burn
(use-trait sip10 .ft-trait.ft-trait)
(use-trait oracle-trait .oracle-trait.oracle-trait);;get-asset-price from token sip10

(impl-trait .a-token-trait.a-token-trait);;transfer-on-liquidation,burn-on-liquidation
(impl-trait .ownable-trait.ownable-trait);;set-contract-owner
