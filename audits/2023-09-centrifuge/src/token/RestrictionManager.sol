...
contract RestrictionManager is Auth {
    ...
    mapping(address => uint256) public members;//Removing an investor from the memberlist in the Restriction Manager locks their tokens. This is expected behaviour.

    constructor() {
        wards[msg.sender] = 1;
        emit Rely(msg.sender);//@note Restrictionmanager owner is PoolManager and Root
    }
