...
contract SophonFarmingTest is Test {
    ...
    function setUp() public {
        ...
        // Deploy proxy
        sophonFarmingProxy = new SophonFarmingProxy(implementation); //@audit-ok tested for all function work . test case use wrong proxy. This use direct implementation instead of proxy.
    ...
    function testDepositEth_TransferDirectly() public {
        console.log(type(uint256).max);
        console.log(2 ** 256 - 1);
        uint256 amountToDeposit = 1.12378e18;
        vm.deal(account1, amountToDeposit);
        vm.startPrank(account1);
        (bool success,) = payable(sophonFarming).call{value: amountToDeposit}("");
        require(success, "fail transfer direct");
    }
