...
contract MeritNFTTest is Test {
    ...
    function testsupportsInterface() public {
        bytes4 accessControlInterface = type(IAccessControlEnumerable).interfaceId;
        assertTrue(nft.supportsInterface(accessControlInterface) );
        bytes4 IERC721EnumerableInterface = type(IERC721Enumerable).interfaceId;
        assertTrue(nft.supportsInterface(IERC721EnumerableInterface) );
