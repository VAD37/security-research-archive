...
abstract contract ERC20Gauges is ERC20 {
    ...
    mapping(address => uint256) public gaugeType;//@note there is only 1 type of gauge which is 1 for termSDAI
    ...
    */
    function incrementGauge(
        ...
        _incrementGaugeWeight(msg.sender, gauge, weight);//@note msg.sender can vote any gauge they want as along as they have enough token to cover vote gauge
    ...
    function _incrementUserAndGlobalWeights(
        ...
        // Ensure under weight
        require(newUserWeight <= balanceOf(user), "ERC20Gauges: overweight");//@note weight gauge always depend on the balance of the user. so gauge decimal same as token decimals
    ...
    */
    ...
    function _addGauge(
        ...
        if (weight != 0) {
            ...
            totalWeight += weight;//@audit R deprecated gauge still have weight but does not count to 
        }
