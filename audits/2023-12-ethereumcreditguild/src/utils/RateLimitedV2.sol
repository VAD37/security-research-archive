...
abstract contract RateLimitedV2 is IRateLimitedV2, CoreRef {
    ...
    uint224 public bufferStored;//2_000_000 * 1e18;
    ...
    constructor(
        uint256 _maxRateLimitPerSecond,//@audit L maxRatelimit is 0. how do they wanna change this later through GOV.
        uint128 _rateLimitPerSecond,
        uint128 _bufferCap//2_000_000 * 1e18;
    ) {
