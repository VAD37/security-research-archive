...
contract RateLimitedMinter is RateLimitedV2 {
    ...
    constructor(
        ...
        uint128 _bufferCap//@note Credittoken limit mint hardcap by 2M  2_000_000 * 1e18;
    )                      //@note GuildToken limit mint by maximum 1B  1_000_000_000 * 1e18; GuildToken can mint more through DAO
        CoreRef(_core)
        RateLimitedV2(_maxRateLimitPerSecond, _rateLimitPerSecond, _bufferCap)
    {
        token = _token;
        role = _role;//@RATE_LIMITED_GUILD_MINTER or @RATE_LIMITED_CREDIT_MINTER
    }
