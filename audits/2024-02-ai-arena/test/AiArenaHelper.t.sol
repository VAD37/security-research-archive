...
contract AiArenaHelperTest is Test {
    ...
    function getProb() public {
        _probabilities.push([25, 25, 13, 13, 9, 9]);//@head: [25, 25, 13, 13, 9, 9] +=94
        _probabilities.push([25, 25, 13, 13, 9, 1]);//@eyes : [25, 25, 13, 13, 9, 1] +=86
        _probabilities.push([25, 25, 13, 13, 9, 10]);//@mouth : [25, 25, 13, 13, 9, 10] +=95
        _probabilities.push([25, 25, 13, 13, 9, 23]);//@body : [25, 25, 13, 13, 9, 23] +=108
        _probabilities.push([25, 25, 13, 13, 9, 1]);//@hands : [25, 25, 13, 13, 9, 1] +=86
        _probabilities.push([25, 25, 13, 13, 9, 3]);//@feet : [25, 25, 13, 13, 9, 3] +=88
    }
