...
contract Neuron is ERC20, AccessControl {
    ...
    //@note only 3M tokens will be leftover for rewards after init minting
        ...
        ERC20("Neuron", "NRN")
    {
        ...
        _mint(treasuryAddress, INITIAL_TREASURY_MINT);//2M
        _mint(contributorAddress, INITIAL_CONTRIBUTOR_MINT);//5M
    }
...
//@note Main ERC20 have unique approve function for staker contract
