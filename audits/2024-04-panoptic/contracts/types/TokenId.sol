...
type TokenId is uint256;//@note TokenId alias of uint256. Weird
...
// (1) tickSpacing      16bits     48bits     : tickSpacing for the univ3pool. Up to 16 bits//@audit TokenId replace last 16bits
