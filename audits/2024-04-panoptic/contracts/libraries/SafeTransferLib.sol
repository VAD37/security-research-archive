...
library SafeTransferLib {//@audit SafeTransferLib fail flashloan callback for UNI,CRV,Frax https://github.com/transmissions11/solmate/issues/346
    /*//////////////////////////////////////////////////////////////
                            ERC20 OPERATIONS
    //////////////////////////////////////////////////////////////*/
    ...
    function safeTransfer(address token, address to, uint256 amount) internal {
        ...
        if (!success) revert Errors.TransferFailed();
    }//@audit L SafeTransferLib missing safeApprove. no one using approve in the codebase
}
