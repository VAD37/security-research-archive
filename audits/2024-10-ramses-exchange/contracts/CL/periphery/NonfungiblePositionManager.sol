    ...
    INonfungiblePositionManager
{
    ...
    function positions(
        ...
        returns (
            address token0,
            address token1,
            int24 tickSpacing,//@audit NFT manager is differ from uniswap public interface? or atleast old version
            int24 tickLower,
            int24 tickUpper,
            uint128 liquidity,
            uint256 feeGrowthInside0LastX128,
        ...
        returns (uint256 tokenId, uint128 liquidity, uint256 amount0, uint256 amount1)
    {
        ...
        _positions[tokenId] = Position({
            ...
            tokensOwed0: 0,
            tokensOwed1: 0
        });//@no nonce and operator address, no NFT id attached to VotingEscrow
    ...
    modifier isAuthorizedForToken(uint256 tokenId) {
        ...
        _checkAuthorized(owner, msg.sender, tokenId);//@inherit from ERC721
        _;
    }
