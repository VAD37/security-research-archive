...
contract GaugeV3 is IGaugeV3 {
    ...
    address public immutable voter;// owner/admin
    IFeeCollector public immutable feeCollector;
    INonfungiblePositionManager public immutable nfpManager;//custom wrap uniswap NFT handler
    ...
    constructor(
        address _voter,//new Voter
        address _nfpManager,//custom uniswapNFT manager
        address _feeCollector,//unique Immutable feeCollector
        address _pool
    ) {
        _unlocked = true;
        ...
        firstPeriod = _blockTimestamp() / WEEK;//@audit-ok what happen when contract deployed at the end of the week on tuesday
