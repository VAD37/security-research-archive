...
contract BurnMintERC677 is IBurnMintERC20, ERC677, ERC20Burnable, AccessControlEnumerable {
  ...
  function grantMintAndBurnRoles(address account) external {//@audit H token forget access control for minter grantMintAndBurnRoles()
    grantRole(MINTER_ROLE, account);// what is the consequence of this. What tokenPool do?
