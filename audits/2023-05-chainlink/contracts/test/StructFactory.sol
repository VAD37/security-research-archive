...
contract StructFactory {
  ...
  function getNopsAndWeights2() internal pure returns (EVM2EVMOnRamp.NopAndWeight[] memory) {
    EVM2EVMOnRamp.NopAndWeight[] memory nopsAndWeights = new EVM2EVMOnRamp.NopAndWeight[](5);
    nopsAndWeights[0] = EVM2EVMOnRamp.NopAndWeight({nop: USER_1, weight: 19284});
    nopsAndWeights[1] = EVM2EVMOnRamp.NopAndWeight({nop: USER_2, weight: 52935});
    nopsAndWeights[2] = EVM2EVMOnRamp.NopAndWeight({nop: USER_3, weight: 8});
    nopsAndWeights[3] = EVM2EVMOnRamp.NopAndWeight({nop: USER_4, weight: 123});
    nopsAndWeights[4] = EVM2EVMOnRamp.NopAndWeight({nop: USER_1, weight: 45645});
    return nopsAndWeights;
  }

  function getNopsAndWeights3() internal pure returns (EVM2EVMOnRamp.NopAndWeight[] memory) {
    EVM2EVMOnRamp.NopAndWeight[] memory nopsAndWeights = new EVM2EVMOnRamp.NopAndWeight[](3);
    nopsAndWeights[0] = EVM2EVMOnRamp.NopAndWeight({nop: USER_2, weight: 12112});
    nopsAndWeights[1] = EVM2EVMOnRamp.NopAndWeight({nop: USER_4, weight: 24654});
    nopsAndWeights[2] = EVM2EVMOnRamp.NopAndWeight({nop: USER_1, weight: 45});
    return nopsAndWeights;
  }
