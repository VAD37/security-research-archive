...
contract EVM2EVMOffRamp_getExecutionState is EVM2EVMOffRampSetup {
  ...
  function test_GetExecutionStateSuccess() public {
    ...
    function test_GetExecutionStateConsole() public {
    s_offRamp.setExecutionStateHelper(0, Internal.MessageExecutionState.FAILURE);
    s_offRamp.setExecutionStateHelper(1, Internal.MessageExecutionState.FAILURE);
    s_offRamp.setExecutionStateHelper(1, Internal.MessageExecutionState.IN_PROGRESS);
    s_offRamp.setExecutionStateHelper(5, Internal.MessageExecutionState.FAILURE);
    s_offRamp.setExecutionStateHelper(64, Internal.MessageExecutionState.IN_PROGRESS);
    s_offRamp.setExecutionStateHelper(63, Internal.MessageExecutionState.SUCCESS);
    s_offRamp.setExecutionStateHelper(127, Internal.MessageExecutionState.IN_PROGRESS);
    s_offRamp.setExecutionStateHelper(128, Internal.MessageExecutionState.SUCCESS);
    s_offRamp.setExecutionStateHelper(5, Internal.MessageExecutionState.SUCCESS);
    console.log("_______________");
    s_offRamp.setExecutionStateHelper(257 + 0, Internal.MessageExecutionState.FAILURE);
    s_offRamp.setExecutionStateHelper(257 + 1, Internal.MessageExecutionState.FAILURE);
    s_offRamp.setExecutionStateHelper(257 + 1, Internal.MessageExecutionState.IN_PROGRESS);
    s_offRamp.setExecutionStateHelper(257 + 5, Internal.MessageExecutionState.FAILURE);
    s_offRamp.setExecutionStateHelper(257 + 64, Internal.MessageExecutionState.IN_PROGRESS);
    s_offRamp.setExecutionStateHelper(257 + 63, Internal.MessageExecutionState.SUCCESS);
    s_offRamp.setExecutionStateHelper(257 + 127, Internal.MessageExecutionState.IN_PROGRESS);
    s_offRamp.setExecutionStateHelper(257 + 128, Internal.MessageExecutionState.SUCCESS);
    s_offRamp.setExecutionStateHelper(257 + 5, Internal.MessageExecutionState.SUCCESS);
  }
      function test_GetExecutionStateConsole2() public {
    s_offRamp.setExecutionStateHelper(1, Internal.MessageExecutionState.SUCCESS);
    s_offRamp.setExecutionStateHelper(0, Internal.MessageExecutionState.UNTOUCHED);
    s_offRamp.setExecutionStateHelper(0, Internal.MessageExecutionState.IN_PROGRESS);
    s_offRamp.setExecutionStateHelper(1, Internal.MessageExecutionState.IN_PROGRESS);
    s_offRamp.setExecutionStateHelper(0, Internal.MessageExecutionState.FAILURE);
    s_offRamp.setExecutionStateHelper(1, Internal.MessageExecutionState.UNTOUCHED);
    s_offRamp.setExecutionStateHelper(0, Internal.MessageExecutionState.SUCCESS);
