...
library MerkleMultiProof {
  ...
  function merkleRoot(
    ...
    unchecked {
      ...
      uint256 totalHashes = leavesLen + proofs.length - 1;//@note skip this openzeppelin check require(leavesLen + proof.length - 1 == totalHashes, "MerkleProof: invalid multiproof");
      if (totalHashes == 0) {
        return leaves[0]; //@audit-ok openzeppelin return proof[0] as backup. this will revert
      }
