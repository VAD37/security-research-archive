...
contract V2Migrator {
    ...
    function migrate(IBathToken bathTokenV1) external { //@audit migration can be called by user. This open up small arbitrage opportunity
        //////////////// V1 WITHDRAWAL ////////////////
        ...
        underlying.approve(bathTokenV2, amountWithdrawn);//@audit underlying approve but does not transfer anything
        require(
