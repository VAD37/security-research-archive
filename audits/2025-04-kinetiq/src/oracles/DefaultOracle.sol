...
contract DefaultOracle is AccessControl {
     ...
     */
    function updateValidatorMetrics(//@https://testnet.purrsec.com/address/0x8efe857cb4dd81709c0e404b8bb1fff3ba40202d/transactions
        address validator,//0x9cd47ac47e6e9cc1441e21ff23d3b3f70ab55a33 EOA
        uint256 balance,//1e18
        uint256 uptime, // 0-10000 basis points  //10000
        uint256 speed, // 0-10000 basis points   //10000
        uint256 integrity, // 0-10000 basis points //10000
        uint256 stake, // 0-10000 basis points   //10000
        uint256 reward,//0
        uint256 slashing//0
        ...
        _validators.add(validator);//@note no way to remove old validators. Just that it can only be stale and ignored from oracle.
//@audit-ok L oracles validators is separated list from actual Validator Managers
