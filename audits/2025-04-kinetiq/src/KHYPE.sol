...
contract KHYPE is ERC20PermitUpgradeable, AccessControlEnumerableUpgradeable {
    ...
    function initialize(
        ...
        string calldata symbol,//KHYPE
        address admin,//admin
        address minter,//stakingManager
        address burner,//stakingManager
        address _pauserRegistry//pause have boolean check require manual call boolean. also all contracts are UUPS by owner
    ) public initializer {
    ...
    function _update(address from, address to, uint256 value) internal virtual override whenNotPaused {
        super._update(from, to, value);//@approve() during pause is possible
    }
}
