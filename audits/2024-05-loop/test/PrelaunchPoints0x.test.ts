...
const tokens = [
  ...
  {
    name: "weETH",
    address: "0xcd5fe23c85820f7b72d0926fc9b05b43e359b7ee",//0xe629ee84c1bd9ea9c677d2d5391919fcf5e7d5d9 OZ erc20
    whale: "0x1C3DC4F4eE50D483289beF519C598847cd447A19",
  },
  {
    name: "ezETH",
    address: "0xbf5495Efe5DB9ce00f80364C8B423567e58d2110",//0x1e756b7bcca7b26fb9d85344b3525f5559bbacb0 OZ erc20
    whale: "0x267ed5f71EE47D3E45Bb1569Aa37889a2d10f91e",
  },
  {
    name: "pufETH",
    address: "0xD9A442856C234a39a81a089C06451EBAa4306a72",//0x39ca0a6438b6050ea2ac909ba65920c7451305c1 OZ ERC20
    whale: "0x176F3DAb24a159341c0509bB36B833E7fdd0a132",
  },
  {
    name: "rsETH",
    address: "0xA1290d69c65A6Fe4DF752f95823fae25cB99e5A7",//0x60ff20bacd9a647e4025ed8b17ce30e40095a1d2 OZ ERC20
    whale: "0x22162DbBa43fE0477cdC5234E248264eC7C6EA7c",
  },
  {
    name: "rswETH",
    address: "0xFAe103DC9cf190eD75350761e95403b7b8aFa6c0",//0xcd284a617b4ed7697c2e455d95049c7fc538785c OZ ERC20
    whale: "0x22162DbBa43fE0477cdC5234E248264eC7C6EA7c",
  },
  {
    name: "uniETH",
    address: "0xF1376bceF0f78459C0Ed0ba5ddce976F1ddF51F4",//0x8a94866df557bb7fce88eff9917237286098e590 OZ ERC20
...
//curl --location --request GET 'https://api.0x.org/swap/v1/quote?sellToken=0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE&buyToken=0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2&sellAmount=1000000000000000000' --header '0x-api-key: [api-key]'
      // Check for error from 0x API
      if (quoteResponse.status !== 200) {
        const body = await quoteResponse.text()
        throw new Error(body)
