...
library Clone {
    ...
    function createClone(address _contract, uint256 _nonce) internal returns (address) {//@audit lots of base contract is proxy. Does this apply to clones pool as well?
