...
contract AlloTest is Test, AlloSetup, RegistrySetupFull, Native, Errors {
    ...
    function setUp() public {
        ...
        vm.stopPrank();
        token2 = IERC20(address(new MissingReturnToken(1e20)));
    }

    function testAudit2() public {
        SafeTransferLib.safeApprove( address(token2), address(3), 1e18);
        SafeTransferLib.safeTransfer( address(token2), address(3), 1e18);
    }
