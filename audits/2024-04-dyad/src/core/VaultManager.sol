...
contract VaultManager is IVaultManager {
  ...
  function liquidate(
      ...
      isValidDNft(to)
    {
      ...
      uint cappedCr               = cr < 1e18 ? 1e18 : cr;//@ cr = 150%
      uint liquidationEquityShare = (cappedCr - 1e18).mulWadDown(LIQUIDATION_REWARD);// 50% * 0.2 = 10%
      uint liquidationAssetShare  = (liquidationEquityShare + 1e18).divWadDown(cappedCr);//@ 110% / 150% = 73.33% 
//1.005e18 *1e18/ 1.02e18 = = 98%
