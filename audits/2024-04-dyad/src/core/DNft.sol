...
contract DNft is ERC721Enumerable, Owned, DNftParameters, IDNft {
  ...
  uint public publicMints;  // Number of public mints //@ 530 public mints
  uint public insiderMints; // Number of insider mints// @ 115 insider mints
//@note on mainnet. price start with 0.1 ether and increase 0.001 ether per mint
  constructor()
