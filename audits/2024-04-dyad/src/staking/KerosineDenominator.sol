...
contract KerosineDenominator is Parameters {
  ...
  function denominator() external view returns (uint) {
    ...
    return kerosine.totalSupply() - kerosine.balanceOf(MAINNET_OWNER);// // 1 billion - multisig
  } // multisig have 950,841,953
}// uniswap v2 have 12,770,656 and 113 ETH
// uniswap v3 605,055
//1,800,000 inside LiquidityBootstrapPool pool