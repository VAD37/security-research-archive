...
contract PermissionedDisputeGame is FaultDisputeGame {
    ...
    address internal immutable PROPOSER;//0x473300df21D047806A082244b417f96b32f13A33   Optimism State Root Proposer
    ...
    constructor(
        ...
        Duration _clockExtension,//10800 
        Duration _maxClockDuration,//302400 
        IBigStepper _vm,//0x0f8EdFbDdD3c0256A80AD8C0F2560B1807873C9c
        IDelayedWETH _weth,//0xE497B094d6DbB3D5E4CaAc9a14696D7572588d14
        IAnchorStateRegistry _anchorStateRegistry,//0x18DAc71c228D1C32c99489B7323d441E1175e443
        uint256 _l2ChainId,//10
        address _proposer,//0x473300df21D047806A082244b417f96b32f13A33 // optimism state root proposer
        address _challenger//0x9BA6e03D8B90dE867373Db8cF1A58d2F7F006b3A //multisig Optimism
    )
        FaultDisputeGame(
            _gameType,
            _absolutePrestate,
