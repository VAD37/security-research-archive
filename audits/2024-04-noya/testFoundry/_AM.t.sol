...
contract TestDebug is testStarter, OptimismAddresses {
    ...
    function testDebugDeposit() public {
        ...
        console.log("redeem 1e6 : %e", accountingManager.previewRedeem(1e6));
        console.log("deposit 1000e6 : %e", accountingManager.previewDeposit(1000e6));
        ...
        console.log("deposit 1000e6 : %e", accountingManager.previewDeposit(1000e6));
        vm.startPrank(alice);
        accountingManager.deposit(address(alice), 35_000e6, address(0));
        vm.stopPrank();
