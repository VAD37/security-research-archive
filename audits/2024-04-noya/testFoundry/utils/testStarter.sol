...
contract testStarter is Test {
    ...
    function deployEverythingNormal(address _base) public {
        ...
        vm.label(address(noyaOracle), "noyaOracle");
        vm.label(address(chainlinkOracle), "chainlinkOracle");
        vm.label(address(accountingManager), "accountingManager");
        vm.label(address(swapHandler), "swapHandler");
        vm.label(address(lifiImplementation), "lifiImplementation");
        vm.label(address(watchers), "watchers");
    }
