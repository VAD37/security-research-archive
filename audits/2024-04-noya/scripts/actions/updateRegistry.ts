...
async function addVaultToRegistry(vaultId: string) {
  ...
  await contract.addVault(
    ...
    "0x8E95f959f1Bd3C4A3Be2bda6089155012fF1a37b",//@EOA account
...
// addVaultToRegistry(
//   "1",
//   "0x663C7979aBF08C618720D7D28E4340B204750247",//@LZ helper on arbitrum one. the deployment address is wrong
