...
contract TestRegistry is testStarter, OptimismAddresses {
    ...
    function testAuditEmergency() public {
        address vaultNewMaintainerUser = address(0x11111111);
        vm.startPrank(owner);
        ...
        console.log("Change vaul address");
        //emergency role must execute changeVaultAddress
        registry.changeVaultAddresses(
            10, owner, vaultNewMaintainerUser, vaultNewMaintainerUser, owner, address(watchers), owner
        );
        //updateConnectorTrustedTokens
        
        //removeTrustedPosition
        console.log("Remove trusted position");
        ...
        console.log("Update connector trusted tokens");
        registry.updateConnectorTrustedTokens(10, address(accountingManager), tokens, true);
        vm.stopPrank();
    }
