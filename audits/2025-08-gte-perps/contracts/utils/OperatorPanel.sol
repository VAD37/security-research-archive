...
abstract contract OperatorPanel is IOperatorPanel {
        ...
        onlySenderOrOperatorHub(account)
    {
        ...
        self.operatorRoleApprovals[account][operator] = approvedRoles | roles;//@audit operators roles does not use enum in power of two. This will just replace operators power and allow operator with multiple permisison despite only want one
