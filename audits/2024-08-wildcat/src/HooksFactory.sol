...
contract HooksFactory is SphereXProtectedRegisteredBase, ReentrancyGuard, IHooksFactory {
  ...
  ) {//@audit R marketInitStorage is really fascinating
    marketInitCodeStorage = _marketInitCodeStorage;// Deployed custom  contract WildcatMarket with trailing STOP instruction
    marketInitCodeHash = _marketInitCodeHash;//WildcatMarket.creationCode
    _archController = archController_;//@WildcatArchController
    sanctionsSentinel = _sanctionsSentinel;//@ EOA
