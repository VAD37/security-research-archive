...
contract SharesRegistry is ISharesRegistry, Ownable2Step {
     ...
     */
    constructor(//@note all ShareRegistry do is store how much collateral per holding, borrowed amount decided by other contracts, config for CR and. Does not hold any tokens
        address _initialOwner,
        address _manager,
        address _token,
        address _oracle,
        bytes memory _oracleData,
        RegistryConfig memory _config //1hour, 5e3 buffer, 8e3 bonus
     ...
     *///@from repay and borrow operations
    ...
    function unregisterCollateral(address _holding, uint256 _share) external override onlyStableManager {
        ...
        }//@note can remove more collateral than available. Only happen during over-withdraw and liquidation
    ...
    function _updateConfig(
        ...
        require(_config.liquidationBuffer <= maxLiquidationBuffer, "3100");//@audit I collateral rate should have cap 100%. because this is inversed ratio. any > 100% will allow user borrow more than available
