...
contract Holding is IHolding, Initializable, ReentrancyGuard {
    ...
    modifier onlyAllowed() {
        ...
        require(
            ...
            "1000"
        );//@note holding allowed share same modifier. Strategy can be abused to call access to any holding. Same for liquidation,swap. Strategy have lots of admin power
        _;
    }
