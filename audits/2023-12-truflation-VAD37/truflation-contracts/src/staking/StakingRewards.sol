...
contract StakingRewards is IStakingRewards, ReentrancyGuard, Pausable, Ownable {
    ...
    address public rewardsToken;//@truf Token
    address public stakingToken;//@LP uniswap Token 
    ...
    constructor(address _rewardsDistribution, address _rewardsToken, address _stakingToken) {
        rewardsToken = _rewardsToken;//@truf Token
        stakingToken = _stakingToken;//@LP uniswap Token
        rewardsDistribution = _rewardsDistribution;//@owner
    }
    ...
    function setRewardsDuration(uint256 _rewardsDuration) external onlyOwner {
        ...
        rewardsDuration = _rewardsDuration;//@audit missing zero check.
