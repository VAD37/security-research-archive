...
contract GoatV1Pair is GoatV1ERC20, ReentrancyGuard {
        ...
        external
    {
        ...
        _virtualEth = params.virtualEth;//@audit pair initParams have initialETH that was not used. Is this suppose to be payable function?
        _bootstrapEth = params.bootstrapEth;//@ Amounts of eth needed to turn pool into an amm
    }
    ...
    function mint(address to) external nonReentrant returns (uint256 liquidity) {
        ...
        if (_vestingUntil == _MAX_UINT32) {//@first mint after init
