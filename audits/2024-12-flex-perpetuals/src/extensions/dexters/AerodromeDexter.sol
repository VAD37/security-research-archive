...
contract AerodromeDexter is Ownable, IDexter {
    ...
    function run(
        ...
        router.swapExactTokensForTokens(_amountIn, 0, routeOf[_tokenIn][_tokenOut], address(this), block.timestamp);//@audit M no slippage protection.
    ...
    }//@audit L anyone can take ERC20 leftover from this contract
