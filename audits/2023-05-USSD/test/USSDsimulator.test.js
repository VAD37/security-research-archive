...
contract('USSD', function (accounts) {
  ...
  it('able to create pool, add collateral and rebalance itself (simulation)', async function () {
    ...
    if (this.USSD.address.toLowerCase().substring(2) > DAI.toLowerCase().substring(2)) {
      ...
      tickLower = "fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff29280"; // tick lower 0.01 * 1e-12 = 0.00000000000001 // -880000
      tickUpper = "00000000000000000000000000000000000000000000000000000000000d6d80"; // tick upper 100 * 1e-12 =  0.00000000100 //880000
    } else {
    ...
    let multiCallParams = [
      ...
      "00000000000000000000000000000000000000000000000000000000000001f4" + // fee 0.05
      sqrtPriceX96, // sqrtPriceX96 = 79228162514264337593543
      // second call
