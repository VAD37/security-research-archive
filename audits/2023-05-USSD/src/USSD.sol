    ...
    AccessControlUpgradeable
{
    ...
    function calculateMint(address _token, uint256 _amount) public view returns (uint256 stableCoinAmount) {
        ...
        return (((assetPrice * _amount) / 1e18) * (10 ** decimals())) / (10 ** IERC20MetadataUpgradeable(_token).decimals());//@audit possible rounded down
    }
    ...
    function mintRebalancer(uint256 amount) public override {//@audit H why mint lack access control
    ...
    function approveToRouter(address _token) public {
        ...
        );//@audit-ok is there any token cannot approve max?
    }
}
