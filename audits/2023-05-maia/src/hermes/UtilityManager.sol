...
abstract contract UtilityManager is IUtilityManager {
    ...
    /// @inheritdoc IUtilityManager
    mapping(address => uint256) public userClaimedWeight;//@note how does claimed work for bHermes
    /// @inheritdoc IUtilityManager
    ...
    function forfeitWeight(uint256 amount) public virtual {
        ...
        address(gaugeWeight).safeTransferFrom(msg.sender, address(this), amount);//@note forfeit does not burn token but allow claim it later
