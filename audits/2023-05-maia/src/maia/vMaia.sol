...
contract vMaia is ERC4626PartnerManager {
    ...
    modifier checkPartnerGovernance(uint256 amount) virtual override {
        ...
        _;
    }//@audit vMaia does not override checkBoost?
     ...
     */
    function beforeWithdraw(uint256, uint256) internal override {//@ok erc4626 hook. empty function
        ...
        unstakePeriodEnd = _unstakePeriodStart + 1 days;//start period always tuesday date 12 AM UTC
    }
