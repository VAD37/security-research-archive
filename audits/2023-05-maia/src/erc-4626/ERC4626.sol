...
abstract contract ERC4626 is ERC20, IERC4626 {
    using SafeTransferLib for address;//@ safetransfer use for all address? not ERC20?
    ...
    function convertToShares(uint256 assets) public view virtual returns (uint256) {
        ...
        return supply == 0 ? assets : assets.mulDiv(supply, totalAssets());//@audit-ok. This is mulDivDown safe as solmate does not mulDil down like in original Solmate. This look like a catastrophic rounding error
    }
