...
- Possible Division by zero value here: <https://github.com/sherlock-audit/2024-11-debita-finance-v3-VAD37/blob/877aca0c5bf364eff2a8b3b0a72df9927b784720/Debita-V3-Contracts/contracts/auctions/Auction.sol#L208>
- `tickPerBlock` created during init: <https://github.com/sherlock-audit/2024-11-debita-finance-v3-VAD37/blob/877aca0c5bf364eff2a8b3b0a72df9927b784720/Debita-V3-Contracts/contracts/auctions/Auction.sol#L93>
...
- Auction Factory allow user to init price same as floor price and set duration be anything. <https://github.com/sherlock-audit/2024-11-debita-finance-v3-VAD37/blob/877aca0c5bf364eff2a8b3b0a72df9927b784720/Debita-V3-Contracts/contracts/auctions/AuctionFactory.sol#L80-L90>

## internal pre-conditions

Here is an sample auction parameteres from user
- Init price = 100e18
- Floor price = 100e18
- duration = 1 days
