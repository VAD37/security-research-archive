...
<https://github.com/sherlock-audit/2024-11-debita-finance-v3-VAD37/blob/877aca0c5bf364eff2a8b3b0a72df9927b784720/Debita-V3-Contracts/contracts/auctions/AuctionFactory.sol#L218-L222>
<https://github.com/sherlock-audit/2024-11-debita-finance-v3-VAD37/blob/877aca0c5bf364eff2a8b3b0a72df9927b784720/Debita-V3-Contracts/contracts/DebitaV3Aggregator.sol#L682-L686>
...
- Any user can call `changeOwner()` with their own address as input and call will always success.
- Current Admin call `changeOwner()` will always fail to change new owner.
...
Not possible to change new admin after deployed. Resulting in redeploy.
...
```solidity
    function testDebugChangeOwner() public {        
        ...
        //random user try change owner. call success
        factory.changeOwner(fakeOwner);
        //but owner never change
