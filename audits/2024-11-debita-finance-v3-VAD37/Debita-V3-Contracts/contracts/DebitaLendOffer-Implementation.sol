...
contract DLOImplementation is ReentrancyGuard, Initializable {
    ...
    function initialize(
        ...
        lendInformation = LendInfo({
            ...
            maxLTVs: _maxLTVs, //@audit-ok not a huge issue. M no maximum 100% check early for max uint to prevent overflow later on.
            apr: _apr,
            ...
            oracle_Collaterals: _oracleIDS_Collateral, //@use when same oracle index is activated
            maxRatio: _ratio,//@skip if oracle is used
