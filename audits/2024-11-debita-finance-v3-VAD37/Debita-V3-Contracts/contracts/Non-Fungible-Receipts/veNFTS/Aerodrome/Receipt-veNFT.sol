...
contract veNFTAerodrome is ReentrancyGuard, ERC721Enumerable {
    ...
    address nftAddress; //Voting Escrow https://basescan.org/address/0xeBf418Fe2512e7E6bd9b87a8F0f294aCDC67e6B4

    struct receiptInstance {
        uint receiptID; // ID of the receipt
        uint attachedNFT; // ID of the NFT attached to the receipt
        uint lockedAmount; // Amount of the NFT locked //@here
        uint lockedDate; // Unlock date of the NFT locked
        uint decimals; // Decimals of the underlying token //@here query by BuyOrder
    ...
    address public _underlying; // Address of the underlying token //AERO 0x940181a94A35A4569E4529A3CDfB74e38FD98631
