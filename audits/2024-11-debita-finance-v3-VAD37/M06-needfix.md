# In `BuyOrderFactory.sol`, multiple problems with `getActiveBuyOrders()` and `getHistoricalBuyOrders()` will cause calls to revert

## Summary

Code typo/Code copy with `getActiveBuyOrders()` and `getHistoricalBuyOrders()` in `BuyOrderFactory.sol` fail to cap limit and offset to array length.
...
<https://github.com/sherlock-audit/2024-11-debita-finance-v3-VAD37/blob/877aca0c5bf364eff2a8b3b0a72df9927b784720/Debita-V3-Contracts/contracts/buyOrders/buyOrderFactory.sol#L143-L147>
<https://github.com/sherlock-audit/2024-11-debita-finance-v3-VAD37/blob/877aca0c5bf364eff2a8b3b0a72df9927b784720/Debita-V3-Contracts/contracts/buyOrders/buyOrderFactory.sol#L163-L167>

The above buggy code look like it was copy from [other contracts](https://github.com/sherlock-audit/2024-11-debita-finance-v3-VAD37/blob/877aca0c5bf364eff2a8b3b0a72df9927b784720/Debita-V3-Contracts/contracts/auctions/AuctionFactory.sol#L166-L185) then modified, but the modification is not complete.
