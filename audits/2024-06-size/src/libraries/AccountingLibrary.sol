...
library AccountingLibrary {
    ...
    function createDebtAndCreditPositions( //@new position when input RESERVED_ID
        State storage state,
        address lender,//always msg.sender
        address borrower,// input 
        uint256 futureValue,//@creditAmountOut. calculated beforehand
        uint256 dueDate//now + input tenor
        ...
        state.data.debtToken.mint(borrower, futureValue);//@ debt token to lender. same amount of creditOut/Future value
    }//@no change
