...
contract DebugForkTest is Test {
    ...
    // function testSellCreditMarketExactAmountIn() public {
    ...
    //         })
    //     );
    //     console.log("---borrower borrows $1000 exactAmountIn==false");
    //     printBalance(alice);
    //     console.log("fee: %e", borrowAToken.balanceOf(feeRecipient));
    //     console.log("credit: %e", size.getCreditPosition(size.data().nextCreditPositionId - 1).credit);
    //     vm.stopPrank();
    //     // debt 1100$
    //     // fee 5$
    //     // receive: 1100$ - 5$ = 1095$
    ...
    // function testSellCreditMarketNonExactAmountIn() public {
    //     _setupForCreditTest(alice);
    //     vm.startPrank(alice);
    ...
    //         })
    //     );
    //     console.log("---borrower borrows $1100 exactAmountIn==true");
    //     printBalance(alice);
    //     console.log("fee: %e", borrowAToken.balanceOf(feeRecipient));
    //     console.log("credit: %e", size.getCreditPosition(size.data().nextCreditPositionId - 1).credit);
    //     vm.stopPrank();
    ...
    // function testBuyCreditMarketExactAmountIn() public {
    //     _setupForCreditTest(alice);
    //     vm.startPrank(alice);
    ...
    //         })
    //     );
    //     console.log("---lender lends $1000 exactAmountIn==true");
    //     printBalance(alice);
    //     console.log("fee: %e", borrowAToken.balanceOf(feeRecipient));
    //     console.log("credit: %e", size.getCreditPosition(size.data().nextCreditPositionId - 1).credit);
    //     vm.stopPrank();
    ...
    // function testBuyCreditMarketNonExactAmountIn() public {
    //     _setupForCreditTest(alice);
    //     vm.startPrank(alice);
    ...
    //         })
    //     );
    //     console.log("---lender lends $1100 exactAmountIn==false");
    //     printBalance(alice);
    //     console.log("fee: %e", borrowAToken.balanceOf(feeRecipient));
    //     console.log("credit: %e", size.getCreditPosition(size.data().nextCreditPositionId - 1).credit);
    //     vm.stopPrank();
