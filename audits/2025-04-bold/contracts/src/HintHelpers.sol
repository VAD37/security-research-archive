...
contract HintHelpers is IHintHelpers {
    ...
    */
        ...
        returns (uint256)
    {
        ...
        uint256 avgInterestRate = activePool.getNewApproxAvgInterestRateFromTroveChange(openTrove);// check new  (allDebt * allInterest) / totalDebt
        return _calcUpfrontFee(openTrove.debtIncrease, avgInterestRate);//7 days fee
    }
