...
contract ScenarioBasicTest is TestDeployer {
    ...
    function test_everyday_functionality() public {
        ...
        address bob = makeAddr("Bob");
        {
            ...
            console.log("USDT total supplies %e", usdt_total_supplies);
            uint256 usdc_total_supplies = cUSD.totalSupplies(address(usdc));
            console.log("USDC total supplies %e", usdc_total_supplies);
            uint256 usdx_total_supplies = cUSD.totalSupplies(address(usdx));
            console.log("USDX total supplies %e", usdx_total_supplies);
            ...
            console.log("cUSD total supply %e", cap_token_supply);
            ...
            console.log("Alice's cUSD balance %e", alice_cUSD_balance);
            console.log("Bob's cUSD balance %e", bob_cUSD_balance);
            console.log("");

            console.log("Alice's USDT balance %e", usdt.balanceOf(alice));
            console.log("Bob's USDC balance %e", usdc.balanceOf(bob));
            console.log("");
