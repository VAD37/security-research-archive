...
contract Staking is IStaking, StakingRewards
	...
	function stakeSALT( uint256 amountToStake ) external nonReentrant
		...
		_increaseUserShare( msg.sender, PoolUtils.STAKED_SALT, amountToStake, false );//@audit audit-issue H-02 I can use uniswap flashloan to stake token and vote execute proposal transfer all DAO token to myself
