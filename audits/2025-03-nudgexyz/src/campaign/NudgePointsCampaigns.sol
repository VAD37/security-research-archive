...
contract NudgePointsCampaigns is INudgePointsCampaign, AccessControl {
    ...
    address public constant NATIVE_TOKEN = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;//@audit M Li.fi native Token is zero address not 0xEeeeE. This might cause confusion during integration with swap caller later down the line
    ...
    function createPointsCampaign(
        ...
        Campaign memory campaign = Campaign({//@not to confused with NudgeCampaign
    ...
    function handleReallocation(
        ...
        address userAddress,
        address toToken,
        uint256 toAmount,//@swap arbitrage protection
        bytes calldata data
        ...
        }//@can receive token from other sources directly.
        ...
        uint256 newpID = ++campaign.pID;//start from 1
