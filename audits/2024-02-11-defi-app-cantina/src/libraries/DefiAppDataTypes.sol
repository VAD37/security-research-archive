...
struct DefiAppHomeCenterStorage {
    address homeToken;
    uint96 currentEpoch;
    address stakingAddress;//defiAppStaker
    uint96 empty_1;
    address poolHelper;//VolatileAMMPoolHelper
    uint128 defaultRps; // defined as "ratePerSecond": as token units (wei) per second // 1e18 
