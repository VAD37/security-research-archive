...
struct MultiFeeDistributionStorage {
    /// Addresses
    address emissionToken;//Home
    address stakeToken;//uniswapV3 HOME/WETH
    ...
    /// Rewards info
    uint256 rewardStreamTime; // Duration that rev rewards are streamed over // 7 days
    uint256 rewardsLookback; // Duration that rewards loop back // 1 days
