...
library LiquidityMath {
    ...
    function deltaRewardsRate72 (uint72 feeMileage, uint72 oldMileage) internal pure
        returns (uint64) {//@audit M math liquidity still use uint64 despite using uint72. The purpose seem tobe clamp value to uint64 max for Q48.48
    ...
    }//@note liquidity math include new math set for uint72
}
