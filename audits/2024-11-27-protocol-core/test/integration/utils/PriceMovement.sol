...
library PriceMovementHelper {
    ...
    function moveToTargetPrice(
        ...
        console.log("underlyingStepAmount %e", underlyingStepAmount);
        uint stepCount;
        ...
        console.log("Force UniswapPriceMovement. Final price: %e , target: %e,steps: %s", currentPrice, targetPrice,stepCount);
        require(
