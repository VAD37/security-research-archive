...
abstract contract ArbitrumMainnetDeployer is BaseDeployer {
    ...
    address constant swapRouterAddress = address(0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45);//Uniswap V3 SwapRouter02
    ...
    function _configureFeeds() internal {
        ...
        _configureFeed(ChainlinkFeed(0x639Fe6ab55C921f74e7fac1ee960C0B6293ba612, "ETH / USD", 86_400, 8, 5));//3590.96000000
        _configureFeed(ChainlinkFeed(0xd0C7101eACbB49F3deCcCc166d238410D6D46d57, "WBTC / USD", 86_400, 8, 5));//96780.91376100
        // TODO use these for cross-feed oracles
        _configureFeed(ChainlinkFeed(0x50834F3163758fcC1Df9973b6e91f0F0F0434aD3, "USDC / USD", 86_400, 8, 10));//.99992702
        _configureFeed(ChainlinkFeed(0x3f3f5dF88dC9F13eac63DF89EC16ef6e7E25DdE7, "USDT / USD", 86_400, 8, 10));//1.00020600
    }
