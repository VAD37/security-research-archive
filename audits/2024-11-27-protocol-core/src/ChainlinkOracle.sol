...
contract ChainlinkOracle is BaseTakerOracle {
    ...
    uint public immutable feedUnitAmount;//e8 for USDC,WETH,WBTC,USDT

    constructor(
        address _baseToken,//WETH 0x82aF49447D8a07e3bd95BD0d56f35241523fBab1
        address _quoteToken,//0xfffff...ff
        address _priceFeed,//0x639Fe6ab55C921f74e7fac1ee960C0B6293ba612  0x50834F3163758fcC1Df9973b6e91f0F0F0434aD3
        string memory _feedDescription,//ETH/USD or USDC/USD
        uint _maxStaleness,//86_400 + 60
        address _sequencerChainlinkFeed //0xFdB631F5EE196F0ed6FAa767959853A9F217697D last time L2 outage?
