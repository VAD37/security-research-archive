...
contract SafeEnabler is GnosisSafeStorage {
     ...
     */
    function enableModule(address module) public {//@SafeModeratorOverridable for ConsoleAccount
        _onlyDelegateCall();//@subaccount include ConsoleAccount 
    ...
    function setGuard(address guard) public {
        ...
        bytes32 slot = _GUARD_STORAGE_SLOT;//@subaccount setGuard SafeModerator
