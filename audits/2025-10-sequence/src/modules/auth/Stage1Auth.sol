...
contract Stage1Auth is BaseAuth, Implementation {
  ...
  constructor(address _factory, address _stage2) {
    ...
    INIT_CODE_HASH = initCodeHash;//0x573fd524dc86b426cf228cb23f874693e22c686ed86eee5bc6720a772e660608
    FACTORY = _factory;
  ...
  function _isValidImage(//@0x9e605e57b90f14aa986a54ec32e1b58d87d06dc90c8018a281752166916d4e21
    bytes32 _imageHash
  ) internal view virtual override returns (bool) {
    return address(uint160(uint256(keccak256(abi.encodePacked(hex"ff", FACTORY, _imageHash, INIT_CODE_HASH)))))
      == address(this);//@this check for CREATE2 salt? keccak(ff + deployer_address + salt + keccak(init_code)) = proxy contract_address
  }//@factory deploy Wallet code + main module address as constructor
