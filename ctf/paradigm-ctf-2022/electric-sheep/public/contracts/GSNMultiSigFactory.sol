...
contract GSNRecipient is Initializable, IRelayRecipient, Context {
    ...
    function _upgradeRelayHub(address newRelayHub) internal {
        ...
        _relayHub = newRelayHub;//@audit relayhub 0xD216153c06E857cD7f72665E0aF1d7D82172F494
    }
...
contract Secondary is Initializable, Context {
    ...
    function initialize(address sender) public initializer {
        _primary = sender;//GSNMultisigFactory or Recipient
...
contract GSNRecipientERC20Fee is Initializable, GSNRecipient {
    ...
    function initialize(string memory name, string memory symbol) public initializer {
        if (_token == __unstable__ERC20PrimaryAdmin(0)) {
            _token = new __unstable__ERC20PrimaryAdmin();//@ admin is sender which owner
            _token.initialize(name, symbol, 18, address(this));//@audit tx constructor call create new token here.
        }
     ...
     */
    function acceptRelayedCall(//@audit H GSNFactory have accept relay call from RelayHub.
        address,
        address from,
        bytes calldata,
        uint256 transactionFee,
...
contract __unstable__ERC20PrimaryAdmin is Initializable, ERC20, ERC20Detailed, Secondary {
    ...
    function initialize(string memory name, string memory symbol, uint8 decimals, address sender) public initializer {
        ...
        Secondary.initialize(sender);//@audit sender is GSNMultisigFactory
    }
...
contract GSNMultisigFactory is GSNRecipientERC20Fee, MinterRole, Ownable {
    ...
    {
        GSNRecipientERC20Fee.initialize(name, symbol);//@audit the goal is minting token out of thin air
